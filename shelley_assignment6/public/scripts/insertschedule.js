...
var Scheduleform = React.createClass({
	...
	handleSubmit: function (e) {
		...
		var schedulesemester = this.state.schedulesemester.trim();
				...
				<table>
					<tbody>
						...
						<tr>
							...
							<td>
								<TextInput
									value={this.state.schedulesemester}
									uniqueName="schedulesemester"
									textArea={false}
									required={true}
									minCharacters={3}
									validate={this.commonValidate}
									onChange={this.setValue.bind(this, "schedulesemester")}
									errorMessage="Schedule Section is invalid"
									emptyMessage="Schedule Section is required"
								/>
							</td>
						</tr>
						<tr>
