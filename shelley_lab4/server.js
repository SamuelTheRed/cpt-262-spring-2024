...
app.post('/employee', function (req, res, ) {
    ...
    var emailer = req.body.employeesalary;
    var etype = req.body.employeetype;

    console.log(ename);

    var sqlins = "INSERT INTO employeetable (dbemployeeid, dbemployeename, dbemployeeemail, "
        + " dbemployeeaddress, dbemployeesalary, dbemployeemailer, dbemployeetype) VALUES (?, ?, ?, ?, ?, ?, ?)";
    var inserts = [eid, ename, eemail, eaddress, esalary, emailer, etype];
