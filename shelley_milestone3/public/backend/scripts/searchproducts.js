      ...
      var productNodes = this.props.data.map(function (product) {
        ...
        return (
          <Product
            ...
            pdcid={product.productid}
            pdcname={product.productname}
            pdcprice={product.productprice}
            pdcquantity={product.productquantity}
            pdcdescription={product.productdescription}
          ></Product>
        );
      });
